...
const LihatKHS: FC = () => {
  ...
  useEffect(() => {
    GetMahasiswaByKHSNotVerified();
  }, []);

  const GetMahasiswaByKHSNotVerified = async () => {
    try {
      const res = await Http.get("/doswal/khs/" + doswal?.NIP + "&" + type, {
      ...
      <div className="w-full flex h-screen">
        ...
        <div className="flex-1 flex flex-col p-4">
          <h1 className="text-4xl font-bold mb-4">
            {type === "true" ? "Copot Verifikasi KHS" : "Verifikasi KHS"}
          </h1>
              ...
              {daftarMahasiswa.map((mahasiswa, index) => (
                ...
                >
                  ...
                  <div className="flex flex-row">
                    <Link
                      to={`/doswal/DetailKHS/` + mahasiswa.NIM + "&" + type}
                    >
