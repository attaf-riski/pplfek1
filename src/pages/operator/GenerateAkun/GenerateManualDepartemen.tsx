...
const GenerateManualDepartemen = () => {
  ...
  const onSubmit = async () => {
    ...
    try {
      const response = await Http.post("/departemen/create", data, {
      ...
      if (response.status === 201) {
        LokalDepartemen.SetDepartemen(response.data.data);
        Swal.fire({
          title: "Berhasil",
          text:
...
export default GenerateManualDepartemen;
