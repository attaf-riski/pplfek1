    ...
    <>
      ...
      <div className="w-full flex h-screen">
        ...
        <div className="flex-1 flex flex-col p-4">
          <h1 className="text-4xl font-bold mb-4">Manajemen Akun</h1>
            ...
            <div className="flex flex-col mt-4 ">
              <div className="flex flex-row justify-between items-center bg-[#162953] rounded-xl px-4 py-2 mb-2">
                ...
                <div className="flex flex-row">
                  <Link to={`/operator/pencarianmahasiswa`}>
              ...
              <div className="flex flex-row justify-between items-center bg-[#162953] rounded-xl px-4 py-2 mb-2">
                ...
                <div className="flex flex-row">
                  <Link to={`/operator/pencariandoswal`}>
                    <button className="bg-[#FBBF24] rounded-xl px-4 py-2">
                      Atur
                    </button>
                  </Link>
              ...
              <div className="flex flex-row justify-between items-center bg-[#162953] rounded-xl px-4 py-2 mb-2">
                ...
                <div className="flex flex-row">
                  <Link to={`/operator/pencariandepartemen`}>
                    <button className="bg-[#FBBF24] rounded-xl px-4 py-2">
                      Atur
                    </button>
                  </Link>
